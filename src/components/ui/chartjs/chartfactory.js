 ...
 * to parameterize
 */
const ChartFactory = (ComponentClass, dataItemName) => {
    const fullDataItemName = dataItemName + 'ChartContext';
    return(
        class ComponentClass extends Component{
            constructor(props){
                ...
                stateResult.chartContexts[fullDataItemName]={
                    timeFrameSelected: '6-days-ago',
                    data:[],
            ...
            componentWillMount(){
                this.props.getHeartRate(this.state.chartContexts[fullDataItemName].timeFrameSelected);
    ...
    function mapStateToProps(state){
        console.log('FACTORYSTATE', state);
        return {
            chartContexts: state.chartContexts
        }
    }
    
    connect(mapStateToProps, actions)(ComponentClass);
}
